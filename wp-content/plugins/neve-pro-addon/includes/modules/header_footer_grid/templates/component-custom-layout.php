...
if ( is_customize_preview() && $current_layout === 'none' ) {
	...
	echo sprintf(
		...
		'<strong>' . __( 'Custom Layouts', 'neve-pro-addon' ) . '</strong>', //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		'<strong>' . esc_html( __( 'Individual Custom Layout', 'neve-pro-addon' ) ) . '</strong>'
	);
