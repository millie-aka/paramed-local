...
class Advanced_Search_Icon extends Advanced_Search_Core {
	...
	public function __construct( $panel ) {
		$this->label = __( 'Advanced Search Icon', 'neve-pro-addon' );
		self::$instance_count ++;
	...
	public function add_settings() {
		...
		SettingsManager::get_instance()->add(
			[
				...
				'default'            => __( 'Search for...', 'neve-pro-addon' ),
				'label'              => __( 'Placeholder', 'neve-pro-addon' ),
				'type'               => 'text',
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'wp_filter_nohtml_kses',
				'default'            => 'canvas',
				'label'              => __( 'Open Behaviour', 'neve-pro-addon' ),
				'type'               => 'select',
				'options'            => [
					'choices' => [
						'canvas'   => __( 'Canvas', 'neve-pro-addon' ),
						'minimal'  => __( 'Minimal', 'neve-pro-addon' ),
						'floating' => __( 'Float Above Header', 'neve-pro-addon' ),
					],
				],
				'section'            => $this->section,
				'conditional_header' => true,
		...
		SettingsManager::get_instance()->add(
			[
				...
				'type'              => 'Neve\Customizer\Controls\Heading',
				'sanitize_callback' => 'sanitize_text_field',
				'label'             => __( 'Search Field', 'neve-pro-addon' ),
				'section'           => $this->section,
				'options'           => [
					'accordion'        => true,
					'controls_to_wrap' => 6,
		...
		SettingsManager::get_instance()->add(
			[
				...
				'tab'                   => SettingsManager::TAB_STYLE,
				'section'               => $this->section,
				'label'                 => __( 'Font Size', 'neve-pro-addon' ),
				'type'                  => '\Neve\Customizer\Controls\React\Responsive_Range',
				'live_refresh_selector' => true,
				'live_refresh_css_prop' => [
					'cssVar'     => [
		...
		SettingsManager::get_instance()->add(
			[
				...
				'label'                 => __( 'Border Width', 'neve-pro-addon' ),
		...
		SettingsManager::get_instance()->add(
			[
				...
				'transport'             => 'postMessage',
				'sanitize_callback'     => 'neve_sanitize_colors',
				'label'                 => __( 'Text and Border', 'neve-pro-addon' ),
	...
	public function change_placeholder( $placeholder ) {
		return get_theme_mod( $this->id . '_' . self::PLACEHOLDER_ID, __( 'Search for...', 'neve-pro-addon' ) );
	}
}
