	...
	public function add_settings() {
		...
		SettingsManager::get_instance()->add(
			[
				...
				'default'            => false,
				'label'              => __( 'Exclude Sticky Posts', 'neve-pro-addon' ),
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'absint',
				'default'            => true,
				'label'              => __( 'Search post title', 'neve-pro-addon' ),
				'type'               => 'neve_toggle_control',
				'section'            => $this->section,
				'conditional_header' => true,
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'absint',
				'default'            => true,
				'label'              => __( 'Search post excerpt', 'neve-pro-addon' ),
				'type'               => 'neve_toggle_control',
				'section'            => $this->section,
				'conditional_header' => true,
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'absint',
				'default'            => true,
				'label'              => __( 'Search post content', 'neve-pro-addon' ),
				'type'               => 'neve_toggle_control',
				'section'            => $this->section,
				'conditional_header' => true,
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'absint',
				'default'            => false,
				'label'              => __( 'Search category/tag title', 'neve-pro-addon' ),
				'type'               => 'neve_toggle_control',
				'section'            => $this->section,
				'conditional_header' => true,
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'absint',
				'default'            => false,
				'label'              => __( 'Search category/tag description', 'neve-pro-addon' ),
				'type'               => 'neve_toggle_control',
				'section'            => $this->section,
				'conditional_header' => true,
			]
		...
		SettingsManager::get_instance()->add(
			array(
				...
				'label'              => __( 'Search in', 'neve-pro-addon' ),
				'type'               => '\Neve\Customizer\Controls\React\Form_Token_Field',
				'default'            => wp_json_encode( [] ),
				'options'            => [
					'choices'     => $cpt_list,
					'description' => __( 'Leave empty to search in all post types', 'neve-pro-addon' ),
				],
				'section'            => $this->section,
