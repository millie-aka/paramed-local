	...
	public function init() {
		...
		$this->set_property(
			...
			sprintf(
				...
				esc_html__( 'Design your %1$s by dragging, dropping and resizing all the elements in real-time. %2$s.', 'neve-pro-addon' ),
		...
		if ( Loader::has_compatibility( 'link_control' ) ) {
			...
			$link_control = new \Neve\Customizer\Controls\React\Link_Control(
				...
				[
					...
					'url'         => $layouts_url,
					'description' => esc_html__( 'Customise further the display of your page headers using custom layouts', 'neve-pro-addon' ),
				]
			);
