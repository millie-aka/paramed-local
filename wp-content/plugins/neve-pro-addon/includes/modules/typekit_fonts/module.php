...
class Module extends Abstract_Module {
	...
	public function define_module_properties() {
		...
		$this->name              = __( 'Typekit Fonts', 'neve-pro-addon' );
		$this->description       = __( 'Easily embed Adobe Fonts in your WordPress website.', 'neve-pro-addon' );
		...
		$this->options = [
			[
				'label'   => __( 'Add Typekit Project ID', 'neve-pro-addon' ),
				'options' => [
					'typekit_id'             => [
						'label'             => __( 'Project ID', 'neve-pro-addon' ),
						'type'              => 'text',
					...
					'typekit_loading_method' => [
						'label'             => __( 'Loading method', 'neve-pro-addon' ),
						'type'              => 'select',
						'choices'           => [
							'css' => esc_html__( 'CSS Link', 'neve-pro-addon' ),
							'js'  => esc_html__( 'Javascript', 'neve-pro-addon' ),
						],
						'default'           => 'css',
						'show_in_rest'      => true,
