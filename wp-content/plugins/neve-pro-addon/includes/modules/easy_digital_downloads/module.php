...
class Module extends Abstract_Module {
	...
	public function define_module_properties() {
		...
		$this->name              = __( 'Easy Digital Downloads Booster', 'neve-pro-addon' );
		$this->description       = __( 'Enhance your Easy Digital Downloads store with additional customization settings.', 'neve-pro-addon' );
