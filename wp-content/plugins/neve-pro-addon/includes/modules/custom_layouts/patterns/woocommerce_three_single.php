...
class Woocommerce_Three_Single extends Abstract_Pattern {
	...
	protected function define_pattern_props() {
		...
		$this->title       = __( 'WooCommerce Single Variation Three Layout', 'neve-pro-addon' );
		$this->description = _x( 'A layout for WooCommerce Product. Inherits from customizer.', 'Block pattern description', 'neve-pro-addon' );
