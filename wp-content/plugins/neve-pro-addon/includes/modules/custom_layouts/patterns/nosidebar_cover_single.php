...
class Nosidebar_Cover_Single extends Abstract_Pattern {
	...
	protected function define_pattern_props() {
		...
		$this->title       = __( 'Cover Single Layout', 'neve-pro-addon' );
		$this->description = _x( 'A layout for single post with cover. Inherits from customizer.', 'Block pattern description', 'neve-pro-addon' );
